  ...
  return (
    <motion.div className=" grid h-full grid-cols-3">
      <motion.div
        ...
        exit="exit"
        className="col-span-1 -ml-10 hidden max-w-[55px] xs:block sm:max-w-[75px] md:max-w-[95px] 2md:max-w-[100px] lg:mr-16 xl:max-w-full"
      >
        <Image
      ...
      <motion.div
        ...
        exit="exit"
        className="col-span-3 max-w-[130px] justify-self-end xs:max-w-[200px] sm:col-span-2 sm:max-w-[150px] md:max-w-[180px] 2md:max-w-[180px] xl:max-w-full"
      >
        <Image
      ...
      <motion.div
        ...
        exit="exit"
        className="col-span-2 hidden max-w-[80px] pl-10 xs:block sm:max-w-[100px] md:max-w-[130px] 2md:max-w-[120px] lg:ml-20 xl:max-w-full"
      >
        <Image
