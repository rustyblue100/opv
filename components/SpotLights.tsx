  ...
  return (
    <motion.div className="grid h-full grid-cols-3">
      <motion.div
        ...
        exit="exit"
        className="col-span-1 -ml-8 hidden max-w-[55px] sm:block sm:max-w-[75px] md:max-w-[75px] 2md:max-w-[100px] lg:-ml-24 lg:max-w-[155px] xl:-ml-36 xl:max-w-[200px] 2xl:max-w-full iphone_landscape:max-w-[50px]"
      >
        <Image
      ...
      <motion.div
        ...
        exit="exit"
        className="col-span-3 max-w-[80px] justify-self-end xxs:max-w-[130px] xs:max-w-[200px] sm:col-span-2 sm:max-w-[150px] md:max-w-[160px] 2md:max-w-[180px] lg:max-w-[240px] xl:max-w-[320px] 2xl:max-w-full iphone_landscape:max-w-[110px] ipadPro:max-w-[320px]"
      >
        <Image
      ...
      <motion.div
        ...
        exit="exit"
        className="col-span-2 hidden max-w-[80px] sm:block sm:max-w-[100px] md:max-w-[110px] 2md:max-w-[120px] lg:ml-4 lg:max-w-[190px] xl:max-w-[220px] 2xl:max-w-full iphone_landscape:max-w-[100px]"
      >
        <Image
